...
/* ============================================================
   ...
   pelaksanaan disimpan BERLINGKUP PERIKATAN (registri AMS_PERSIST_SCOPE di
   contexts.tsx → ams.v1.engagement.<engId>.pfi3400.exec); sebelumnya kunci ini
   jatuh ke lingkup FIRMA, sehingga centang prosedur satu perikatan terbaca
   sebagai pekerjaan yang sudah dilakukan pada perikatan klien lain.
   ...
   (Asurans Lain · Portofolio Jasa · Matriks Kepatuhan) memanggil `pfiEngine()`
   TANPA argumen, dan cadangan di dalamnya membaca kunci TAK-BERLINGKUP
   `ams.v1.pfi3400.exec` — kunci pra-W6 yang tak pernah lagi ditulis aplikasi
   (satu-satunya penulis cache adalah `cacheWrite`, yang beralamat
   scope+scopeId). Pembaca itu karena itu selalu memakai status seed, bukan
   pekerjaan auditor, baik sebelum maupun sesudah perubahan lingkup ini.
   ============================================================ */
