...
function SYCard({ value, label, sub, accent }) {
  return (
...
function SYKv({ label, v, strong, accent, indent }) {
  return (
...
function SYSourceUse({ title, sub, sumber, penggunaan, sumberLbl, pakaiLbl, saldoAwal, fmt, renderRow }) {
