            ...
            <div className="grid" style={{ gap: 12 }}>
              ...
              <Panel noBody>
                <div style={{ background: 'linear-gradient(120deg,var(--navy-700),var(--blue-solid))', color: 'var(--on-dark-fg)', padding: '14px 16px' }}>
                  <div className="tiny upper" style={{ color: 'var(--on-dark-muted)', letterSpacing: '.05em', marginBottom: 8 }}>Kesimpulan Audit — PSAK 25</div>
                  <div className="row ac gap12">
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div className="tiny" style={{ color: 'var(--on-dark-muted)', marginTop: 6 }}>{procDone}/{P25_PROC.length} prosedur · {discDone}/{P25_DISC.length} pengungkapan</div>
                    </div>
                  </div>
                </div>
