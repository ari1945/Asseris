    ...
    <div className="panel" style={{ background: '#fff', maxWidth: 880, margin: '0 auto', width: '100%', padding: '30px 38px 34px', boxShadow: 'var(--shadow)' }}>
      ...
      <div className="row jb" style={{ alignItems: 'flex-start', gap: 18, paddingBottom: 14, borderBottom: '2px solid var(--navy)' }}>
        <div style={{ minWidth: 0 }}>
          ...
          <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--ink)', marginTop: 9 }}>Kertas Kerja — Penurunan Nilai Piutang Usaha (ECL)</div>
          <div className="tiny muted">Kerugian Kredit Ekspektasian · PSAK 71 (IFRS 9) · pendekatan disederhanakan</div>
        </div>
        <div style={{ textAlign: 'right', flex: '0 0 auto' }}>
          <div className="mono" style={{ display: 'inline-block', border: '1.5px solid var(--navy)', borderRadius: 7, padding: '5px 12px', fontSize: 15, fontWeight: 800, color: 'var(--navy)' }}>B-7</div>
              ...
              <div className="grid" style={{ gap: 12 }}>
                <Panel noBody>
                  <div style={{ background: 'linear-gradient(120deg,#013a52,#005085)', color: 'var(--on-dark-fg)', padding: '14px 16px' }}>
                    <div className="tiny upper" style={{ color: 'var(--on-dark-muted)', letterSpacing: '.05em', marginBottom: 8 }}>Kesimpulan Audit — Estimasi ECL</div>
                    <div className="row ac gap12">
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div className="tiny" style={{ color: 'var(--on-dark-muted)', marginTop: 6 }}>{doneCount}/{P71_PROC.length} prosedur audit selesai</div>
                      </div>
                    </div>
                  </div>
