...
import { P58_GROUP, psak58, reconcile, GROUP_SUBS, GROUP_ASSOCIATES, GROUP_CONTROL, INTERCO, psak65, groupMateriality, consolidatedBenchmarks } from './canon_part3';
...
const AMS_CANON_BASE = {
  ...
  goingConcern,
  psak65, groupMateriality, consolidatedBenchmarks, GROUP_SUBS, GROUP_ASSOCIATES, GROUP_CONTROL, INTERCO,
