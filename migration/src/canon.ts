...
import { P58_GROUP, psak58, reconcile, GROUP_SUBS, GROUP_ASSOCIATES, GROUP_CONTROL, INTERCO, psak65, groupMateriality } from './canon_part3';
...
const AMS_CANON_BASE = {
  ...
  goingConcern,
  psak65, groupMateriality, GROUP_SUBS, GROUP_ASSOCIATES, GROUP_CONTROL, INTERCO,
