...
import { smmEvalPeriod } from './canon_smm_period';
  ...
  /* ============================================================
     SMM 1 GOVERNANCE — 8 komponen SMM, akuntabilitas, sumber daya,
  ...
  const QM_ROLES = [
    ...
    { role: 'Kepemimpinan Etika & Independensi', person: 'Sari Dewanti, CPA', title: 'Ethics & Independence Partner', ref: 'SMM 1 ¶20(c)', since: '2021', note: 'Kepatuhan kode etik IAPI, register independensi & rotasi.' },
    { role: 'Kepemimpinan Pemantauan & Remediasi', person: 'Citra Halim, CPA', title: 'Monitoring Partner', ref: 'SMM 1 ¶20(c)', since: '2022', note: 'Program inspeksi perikatan, akar masalah & remediasi defisiensi.' },
  ];
  const QM_PROVIDERS = [
    ...
    { name: 'Metodologi Audit WHR v4.2', type: 'Sumber Daya Intelektual', reliance: 'Kerangka kerja & template perikatan', evaluated: '2026-01', status: 'Memadai', note: 'Diperbarui selaras SA & SMM terkini; di-review komite teknis.' },
  ...
  const DELIVERY = [
    { id: 'ENG-2025-063', phases: [
      ...
      milestones: [
        { label: 'Draft LK final', kind: 'other', date: '2026-03-02', status: 'done' },
        { label: 'EQR (SA 220)', kind: 'eqr', date: '2026-03-10', status: 'due' },
        { label: 'Tanda tangan opini', kind: 'signoff', date: '2026-03-15', status: 'upcoming' } ] },
    { id: 'ENG-2025-014', phases: [
      ...
      milestones: [
        { label: 'Kickoff', kind: 'kickoff', date: '2026-01-12', status: 'done' },
        { label: 'Interim review', kind: 'interim', date: '2026-02-13', status: 'done' },
        { label: 'Observasi stock opname', kind: 'stocktake', date: '2026-02-27', status: 'done' },
        { label: 'Selesai fieldwork', kind: 'fieldwork-end', date: '2026-03-20', status: 'due' },
        { label: 'EQR', kind: 'eqr', date: '2026-03-26', status: 'upcoming' },
        { label: 'Sign-off', kind: 'signoff', date: '2026-03-31', status: 'upcoming' } ] },
    { id: 'ENG-2025-031', phases: [
      ...
      milestones: [
        { label: 'Kickoff', kind: 'kickoff', date: '2026-01-19', status: 'done' },
        { label: 'Stock opname CPO', kind: 'stocktake', date: '2026-03-06', status: 'done' },
        { label: 'Konfirmasi piutang', kind: 'confirmation', date: '2026-03-27', status: 'due' },
        { label: 'Selesai fieldwork', kind: 'fieldwork-end', date: '2026-04-17', status: 'upcoming' },
        { label: 'Sign-off', kind: 'signoff', date: '2026-04-30', status: 'upcoming' } ] },
    { id: 'ENG-2025-040', phases: [
      ...
      milestones: [
        { label: 'Kickoff', kind: 'kickoff', date: '2026-02-02', status: 'done' },
        { label: 'Risk assessment', kind: 'other', date: '2026-02-27', status: 'done' },
        { label: 'Walkthrough pengendalian', kind: 'other', date: '2026-04-02', status: 'upcoming' },
        { label: 'Selesai fieldwork', kind: 'fieldwork-end', date: '2026-04-08', status: 'upcoming' },
        { label: 'Sign-off', kind: 'signoff', date: '2026-04-15', status: 'upcoming' } ] },
    { id: 'ENG-2025-022', phases: [
      ...
      milestones: [
        { label: 'Kickoff', kind: 'kickoff', date: '2026-02-16', status: 'done' },
        { label: 'Prosedur analitis', kind: 'other', date: '2026-04-10', status: 'upcoming' },
        { label: 'Selesai prosedur', kind: 'fieldwork-end', date: '2026-05-15', status: 'upcoming' },
        { label: 'Laporan reviu', kind: 'signoff', date: '2026-05-31', status: 'upcoming' } ] },
    { id: 'ENG-2025-047', phases: [
      ...
      milestones: [
        { label: 'Kickoff', kind: 'kickoff', date: '2026-03-02', status: 'done' },
        { label: 'Scoping AUP', kind: 'other', date: '2026-03-20', status: 'due' },
        { label: 'Mulai prosedur', kind: 'other', date: '2026-04-20', status: 'upcoming' },
        { label: 'Laporan temuan faktual', kind: 'signoff', date: '2026-06-30', status: 'upcoming' } ] },
    { id: 'ENG-2025-058', phases: [
      ...
      milestones: [
        { label: 'Sign-off opini', kind: 'signoff', date: '2026-02-26', status: 'done' },
        { label: 'Arsip (SMM)', kind: 'archive', date: '2026-02-28', status: 'done' } ] },
  ];
