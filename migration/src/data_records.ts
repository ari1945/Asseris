...
(function () {
  ...
  const RETENTION_CLASSES = [
    { id: 'kk-audit',  jenis: 'Berkas Audit / Kertas Kerja (final)', dasar: 'SA 230 ¶A23 / SMM 1 — min. 5 thn sejak tanggal laporan', years: 7,  format: 'Elektronik terenkripsi (AES-256)', types: ['Kertas Kerja'], note: 'WHR menetapkan 7 tahun, melebihi minimum SA 230. Mengikat masa simpan kotak arsip perikatan audit.' },
    { id: 'asurans',   jenis: 'Berkas Asurans & Reviu (SPR/SJAH)',    dasar: 'SMM 1 / SPR 2400 / SJAH 3000',                       years: 7,  format: 'Elektronik terenkripsi',          types: ['Laporan'],      note: 'Reviu (SPR 2400) & asurans lain — selaras berkas audit.' },
    ...
    { id: 'eqr',       jenis: 'Telaah Mutu Perikatan (EQR)',           dasar: 'SMM 2 / SMM 1',                                     years: 7,  format: 'Elektronik terenkripsi',          types: ['EQR'],          note: 'Memo & dokumentasi penelaah pengendalian mutu.' },
