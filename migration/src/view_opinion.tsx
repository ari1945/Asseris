...
const OPINION_PARA_O = (type: any, basisTitle: any, client: any) => (({
  unmodified: `Menurut opini kami, laporan keuangan konsolidasian terlampir menyajikan secara wajar, dalam semua hal yang material, posisi keuangan konsolidasian ${client} dan entitas anaknya tanggal 31 Desember 2025, serta kinerja keuangan dan arus kasnya untuk tahun yang berakhir pada tanggal tersebut, sesuai dengan Standar Akuntansi Keuangan di Indonesia.`,
  qualified: `Menurut opini kami, kecuali untuk dampak hal yang dijelaskan dalam paragraf "${basisTitle}", laporan keuangan konsolidasian terlampir menyajikan secara wajar, dalam semua hal yang material, posisi keuangan konsolidasian ${client} dan entitas anaknya tanggal 31 Desember 2025, serta kinerja keuangan dan arus kasnya untuk tahun yang berakhir pada tanggal tersebut, sesuai dengan Standar Akuntansi Keuangan di Indonesia.`,
  adverse: `Menurut opini kami, karena signifikannya hal yang dijelaskan dalam paragraf "${basisTitle}", laporan keuangan konsolidasian terlampir tidak menyajikan secara wajar posisi keuangan konsolidasian ${client} dan entitas anaknya tanggal 31 Desember 2025, serta kinerja keuangan dan arus kasnya untuk tahun yang berakhir pada tanggal tersebut, sesuai dengan Standar Akuntansi Keuangan di Indonesia.`,
  disclaimer: `Kami tidak menyatakan suatu opini atas laporan keuangan konsolidasian ${client} dan entitas anaknya terlampir. Karena signifikannya hal yang dijelaskan dalam paragraf "${basisTitle}", kami tidak dapat memperoleh bukti audit yang cukup dan tepat untuk menyediakan suatu basis bagi opini audit atas laporan keuangan tersebut.`,
} as any)[type]);

const OP_TXT = {
  intro: (client: any) => `Kami telah mengaudit laporan keuangan konsolidasian ${client} dan entitas anaknya (“Grup”), yang terdiri dari laporan posisi keuangan konsolidasian tanggal 31 Desember 2025, serta laporan laba rugi, perubahan ekuitas, dan arus kas konsolidasian untuk tahun yang berakhir pada tanggal tersebut, dan suatu ikhtisar kebijakan akuntansi signifikan.`,
  basisStd: (modified: any) => `Kami melaksanakan audit kami berdasarkan Standar Audit (“SA”) yang ditetapkan oleh Institut Akuntan Publik Indonesia. Tanggung jawab kami menurut standar tersebut diuraikan lebih lanjut dalam paragraf Tanggung Jawab Auditor. Kami independen terhadap Grup sesuai dengan ketentuan etika yang relevan, dan kami yakin bahwa bukti audit yang telah kami peroleh adalah cukup dan tepat untuk menyediakan suatu basis bagi opini ${modified ? '' : 'audit'} kami.`,
  gc: 'Kami mengarahkan perhatian pada Catatan atas laporan keuangan yang menjelaskan adanya ketidakpastian material yang dapat menyebabkan keraguan signifikan atas kemampuan Grup untuk mempertahankan kelangsungan usahanya. Opini kami tidak dimodifikasi sehubungan dengan hal tersebut.',
...
/* SA 600 PR-3a — prosa laporan diekspor agar dapat diuji langsung: teks opini adalah
   DELIVERABLE audit, dan deliverable yang hanya teruji lewat render UI tidak teruji. */
export { comparativeParagraph, DEFAULT_COMP_O, PRED_OPINION_LABEL, OPINION_PARA_O, OP_TXT };
