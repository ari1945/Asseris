...
export const AMS: AmsData = {
  ...
  FIRM_PERIOD_END, BANK_ACCOUNTS, BANK_RECONS, FIRM_BUDGET, CASH_FORECAST, FIXED_ASSETS,
  TAX_OBLIGATIONS, EFAKTUR, PPH_WITHHELD, CREDIT_NOTES,
