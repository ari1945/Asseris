...
import { FIRM, USER, CLIENTS, ENGAGEMENTS, WTB, AJE, RISKS, TEAM, WORKPAPERS, ACTIVITY, DEADLINES, REVIEW_NOTES, TIME_ENTRIES, PIPELINE, INVOICES, SCHEDULE, STAFF, EXITS, AP_SIGNING_HISTORY, UNITS, FIRM_STAFF, CPE_REQ, CPE_LOG, INDEPENDENCE, FIRM_COA, FIRM_GL, FIRM_AP, AR_BRIDGE, AP_BRIDGE, ACC_FACTORS, PROSPECTS } from './data_part1';
import { FIRM_PERIOD_END, BANK_ACCOUNTS, BANK_RECONS, FIRM_BUDGET, FIRM_BUDGET_FY, CASH_FORECAST, FIXED_ASSETS, TAX_OBLIGATIONS, EFAKTUR, PPH_WITHHELD, CREDIT_NOTES, PAYROLL, PAYROLL_RATES, LEAVE_HOLIDAYS, LEAVE_BALANCE, LEAVE_REQUESTS, PERF_CYCLE, SOQM_RISKS, COMPLAINTS, EQR_REVIEWS, PPPK_REPORT, PBC_REQUESTS, PORTAL_MSGS, DMS_DOCS, NONAUDIT, REVIEW_2400, AUP_4400, aupNarrate, aupEvalMeasure, aupEngine, COMPILATION_4410, PFI_3400 } from './data_part2';
import { pfiEngine, SOC_3402, socEngine, GHG_3410, ghgEngine, ASSURANCE_ENG, BI_DATA, REVIEW_2400_PLAN } from './data_part3';
import { DD_OPP, DD_PROS, DD_REG, DD_EBITDA_BRIDGE, DD_NORM_EBITDA, DUE_DILIGENCE, SMM_OBJECTIVE_WAIVERS, QM_COMPONENTS, QM_ROLES, QM_PROVIDERS, QM_NETWORK, QM_CULTURE, QM_EVAL, QM_INSPECTIONS, QM_INSP_FINDINGS, QM_MON_ACTIVITIES, QM_DOC_RETENTION, EQR_META, EQR_PARTNER_HISTORY, PPPK_CLIENTS, PPPK_PPL, PPPK_ROTATION, PPPK_HISTORY, TODAY, DELIVERY_WINDOW, DELIVERY, WIP_ENG, ENG_FEE_REALIZATION, WIP_NONMATERIAL, WIP_ACCRUAL, CAPACITY, _engIndex, _cliIndex, engById, clientById, shortName, bareName, staffByName, industryTag, engMeta } from './data_part4';
...
export const AMS: AmsData = {
  ...
  TODAY, DELIVERY, DELIVERY_WINDOW, WIP_ENG, ENG_FEE_REALIZATION, WIP_NONMATERIAL, WIP_ACCRUAL, CAPACITY,
  SMM_OBJECTIVE_WAIVERS,
  QM_COMPONENTS, QM_ROLES, QM_PROVIDERS, QM_NETWORK, QM_CULTURE, QM_EVAL,
  QM_INSPECTIONS, QM_INSP_FINDINGS, QM_MON_ACTIVITIES, QM_DOC_RETENTION, EQR_META, EQR_PARTNER_HISTORY,
  PPPK_CLIENTS, PPPK_PPL, PPPK_ROTATION, PPPK_HISTORY,
  WORKPAPERS, ACTIVITY, DEADLINES,
  REVIEW_NOTES, TIME_ENTRIES, PIPELINE, INVOICES, SCHEDULE, STAFF, EXITS, AP_SIGNING_HISTORY, UNITS, FIRM_STAFF, CPE_REQ, CPE_LOG, INDEPENDENCE,
  FIRM_COA, FIRM_GL, FIRM_AP, AR_BRIDGE, AP_BRIDGE, PROSPECTS,
  FIRM_PERIOD_END, BANK_ACCOUNTS, BANK_RECONS, FIRM_BUDGET, FIRM_BUDGET_FY, CASH_FORECAST, FIXED_ASSETS,
  TAX_OBLIGATIONS, EFAKTUR, PPH_WITHHELD, CREDIT_NOTES,
  PAYROLL, PAYROLL_RATES, LEAVE_HOLIDAYS, LEAVE_BALANCE, LEAVE_REQUESTS, PERF_CYCLE,
