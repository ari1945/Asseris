...
function DataPersonalSaya() {
  ...
  return (
    <>
      ...
      <div className="view-scroll"><div className="view-pad">
        <div className="panel" style={{ background: 'linear-gradient(120deg,var(--navy-700),var(--blue-solid))', color: 'var(--on-dark-fg)', padding: '16px 18px', display: 'flex', gap: 13, alignItems: 'center', marginBottom: 12 }}>
