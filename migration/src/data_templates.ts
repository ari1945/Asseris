...
(function () {
  ...
  const TEMPLATES = [
    ...
    /* ---------- Tata Kelola & Mutu ---------- */
    { id: 'TPL-QM-01', name: 'Audit Methodology Pack', fmt: 'DOCX', phase: 'Tata Kelola & Mutu', cat: 'Metodologi & SMM',
      ver: '4.2', updated: '2026-01-02', steward: 'Tim Metodologi', status: 'Aktif', module: 'governance',
      sa: [{ code: 'SMM 1' }, { code: 'SA 220' }], dl: 92, engs: ([] as any[]), dmsDoc: 'DOC-0701',
      nextReview: '2027-01-02', retention: 3, desc: 'Pack metodologi firma menyeluruh — selaras SMM & SA 315 (revisi). Diarsipkan & dikendalikan di DMS.' },
    { id: 'TPL-QM-02', name: 'EQR Review Checklist', fmt: 'DOCX', phase: 'Tata Kelola & Mutu', cat: 'Metodologi & SMM',
    ...
    { id: 'TPL-QM-03', name: 'Acceptance & Continuance', fmt: 'DOCX', phase: 'Tata Kelola & Mutu', cat: 'Metodologi & SMM',
