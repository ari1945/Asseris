            ...
            <div className="grid" style={{ gap: 12 }}>
              ...
              <Panel noBody>
                <div style={{ background: 'linear-gradient(120deg,var(--navy-700),var(--blue-solid))', color: 'var(--on-dark-fg)', padding: '14px 16px' }}>
                  <div className="tiny upper" style={{ color: 'var(--on-dark-muted)', letterSpacing: '.05em', marginBottom: 8 }}>Kesimpulan Audit — {supp ? 'DTA Didukung' : 'Recoverability Diragukan'}</div>
