...
> **2026-09-07 — SERAH-TERIMA.** Status repo yang berlaku (master `8f434de`, PR terbuka,
...
> gelombang W1 ditutup, dan W2 (`DEFAULT_ENG_ID`) dibuka lewat PR #335 (mendarat `09eb979`; prompt `W2-1-DEFAULT-ENG-ID.md`). Instruksi agen
