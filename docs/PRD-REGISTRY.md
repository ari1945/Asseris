...
| docs/prd-regulatory-reference-annual.md | In Progress — Proceed. 2026-08-19 untuk **Tahap A** (mekanisme; Tahap B admin-editable dinilai ulang kemudian). Q-3 = blokir yang menyangkut uang. **PR-1 SELESAI** — `canon_regref.ts` (registry berkunci masa berlaku, tanpa "yang terdekat") + kalender hari libur dimigrasi NOL-DELTA (60 uji cuti lama hijau tanpa disentuh). PR-2 BPJS · PR-3 TER/PTKP · PR-4 halaman referensi + gerbang cakupan menyusul |
