...
| docs/prd-addressable-tabs.md | Draft — V-9 (tinjauan visual 2026-08-14): ganti tab tidak menulis hash & `hashchange` abaikan `loc.tab`. **Q-1..Q-3 TERJAWAB** (Claude atas delegasi Ari 2026-08-14): migrasi atas pemicu (bukan 61 modul) · `replaceState` · sumbu `sel` tetap Non-Scope. F-3 dicabut → dua fase; menunggu sign-off ("Proceed.") |
